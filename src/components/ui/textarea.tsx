...
>(({ className, ...props }, ref) => (
  <textarea
    ref={ref}
    className={cn(
      'border-input bg-card placeholder:text-muted-foreground/70 flex min-h-24 w-full rounded-lg border px-3 py-2 text-base sm:text-[15px] shadow-xs transition-colors',
